function Load_Projects() {
    ...
    document.getElementById('content_books').innerHTML = '<div class="spinner-grow" role="status"><span class="sr-only">Loading...</span></div>'
    ...
    xhr.addEventListener("readystatechange", function () {
        if (this.readyState === 4) {
            ...
            if (datos.Response != 0) {
                ...
                var html = document.getElementById('content_books');
                html.innerHTML = '';
                var contid = 1;
    ...
    xhr.open("GET", baseurl + "contents/type/2");
    ...
    xhr.addEventListener("readystatechange", function () {
        if (this.readyState === 4) {
            ...
            if (datos.Response != 0) {
                ...
                document.getElementById('modalEdit_sextrainfo').value = datos.Response[0].content_extrainfo;
